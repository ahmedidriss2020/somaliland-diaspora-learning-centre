...
import { Sparkles, Calendar, User, Mail, Phone, BookOpen, Clock, CheckCircle2 } from "lucide-react";
...
export function BookingModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.success("Free Assessment Reserved!", {
      description: `Thank you ${formData.parentName}. We've sent details to ${formData.email} to confirm ${formData.childName}'s slot.`,
      duration: 5000,
    });
    onClose();
    setStep(1);
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          <div className="flex items-center gap-2 mb-1">
            <Badge variant="accent" className="text-[10px]">Free Trial Lesson</Badge>
            <span className="text-xs text-slate-400 font-medium">• No Credit Card Required</span>
          </div>
          <DialogTitle>Book Free Child Placement & Assessment</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
          ...
          {step === 1 ? (
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="tarbiyah">Tarbiyah & Islamic Studies</option>
              ...
              <div className="p-3 bg-indigo-50 rounded-xl border border-indigo-100 text-xs text-indigo-900 flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0" />
                <span>Our coordinator will WhatsApp/email you within 2 hours to confirm your tutor.</span>
              </div>
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <Button type="submit" variant="accent" className="shadow-lg shadow-orange-500/20">
